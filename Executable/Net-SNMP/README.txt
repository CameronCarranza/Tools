...
BUILD INFORMATION
  ...
  Name:			net-snmp-5.6.1.1-1.win32.exe
  URL:			http://www.net-snmp.org
  Build date:	2011-08-09
  Built by:		Dave Shield
  Installer Package by: Alex Burger, Dave Shield
  NSIS Compiler:	Version 2.46
  
  OS:			Windows 7
  Compiler:		MSVC++ 9.0
  Windows SDK:	6.0A	August 2010
  Perl:			ActivePerl 5.12.1

  Source: 		net-snmp-5.6.1.1.zip
  Patches		mib.c:_mibindex_add (7f115df8336e3b9ea952300b3d4d104eb2140cdb and
				                     e46b170117fe78a2faabef1adcc3d6d4d5696036)
  Destination:  	c:\usr
